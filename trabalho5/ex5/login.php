<?php
                ...
                $emailStr = carregaString("../email.txt");
                $senhaStr = carregaString("../senhaHash.txt");
                
                $emailLogin = $_POST['email'];
                $senhaLogin = $_POST['senha'];

                if($emailLogin == $emailStr && (password_verify($senhaLogin, $senhaStr))){
    ...
    <body class = "container">
        ...
        <div class="login">
            ...
            buttonClose.addEventListener("click", function(){
                window.location.href = "/trabalho5/ex5/index.html"
                })
            }
        </script>
</body>
